"""Monitor Memory of a CFME/Miq appliance and build graphs displaying usage per process."""
from conf import env, cfme_data
...
def create_report(test_name, results_dir, provider_names, appliance_results, process_results,
    ...
    memory_path = log_path.join('{}-{}-{}'.format(test_ts, test_name, ver))
